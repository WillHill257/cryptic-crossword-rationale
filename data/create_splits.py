...
def write_splits_to_json(
    filename: str, train: List[Clue], validation: List[Clue], test: List[Clue]
) -> None:
    ...
    data = {
        "train": [elem.to_map() for elem in train],
        "validation": [elem.to_map() for elem in validation],
        "test": [elem.to_map() for elem in test],
    }
